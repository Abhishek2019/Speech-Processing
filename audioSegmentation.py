...
def speakerDiarization(filename, n_speakers, mt_size=2.0, mt_step=0.2, 
	...
	[classifier_1, MEAN1, STD1, classNames1, mtWin1, mtStep1, stWin1, stStep1, computeBEAT1] = aT.load_model_knn("data/knnSpeakerAll")
	...
	[classifier_2, MEAN2, STD2, classNames2, mtWin2, mtStep2, stWin2, stStep2, computeBEAT2] = aT.load_model_knn("data/knnSpeakerFemaleMale")
